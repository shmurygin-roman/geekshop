...
def forwards_func(apps, schema_editor):
    ...
    # Create new category
    pro_cat_obj = pro_cat_model.objects.create(pk=1, name="home", description="Excellent furniture for home interiors.")
    ...
    pro_cat_obj = pro_cat_model.objects.create(
        pk=2, name="office", description="Elegant and dependable office furniture of the new generation."
    )
    # Create new products in this category
    pro_model.objects.create(
        pk=4,
    ...
    # Create new category
    pro_cat_obj = pro_cat_model.objects.create(
        pk=3, name="modern", description="MODERN furniture is suitable for any interior."
    )
    # Create new products in this category
    pro_model.objects.create(
        pk=6,
    ...
    # Create new category
    pro_cat_obj = pro_cat_model.objects.create(
        pk=4, name="classic", description="Classic style is relevant at any time."
    )
    # Create new products in this category
    pro_model.objects.create(
        pk=8,
